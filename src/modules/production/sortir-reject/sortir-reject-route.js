...
router.get(
  "/sortir-reject",
  verifyToken,
  sortirRejectController.getAllSortirReject,
);
...
router.post(
  "/sortir-reject",
  verifyToken,
  sortirRejectController.createSortirReject,
);

router.put(
  "/sortir-reject/:noBJSortir",
  verifyToken,
  sortirRejectController.updateSortirReject,
);
...
router.get(
  "/sortir-reject/:noBJSortir/outputs/reject",
  verifyToken,
  sortirRejectController.getOutputsRejectByNoBJSortir,
);
